...
### Extras
# This is not from mycroft core
def annotate_datetime_en(string, dateNow=None, default_time=None):
    """ Convert a human date reference into an exact datetime
...
if __name__ == "__main__":
    print(annotate_duration_en("set a timer for 5 minutes"))
    print(annotate_datetime_en("next tuesday morning i have a meeting"))
